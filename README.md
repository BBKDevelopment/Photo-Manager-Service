...
**❗ In order to start using Photo Manager Service you must have the [Flutter SDK][flutter_install_link] installed on your machine.**

Add `photo_manager_service` to your `pubspec.yaml`:
...
Photo Manager Service comes with a built-in [GitHub Actions workflow][github_actions_link] powered by [Very Good Workflows][very_good_workflows_link] but you can also add your preferred CI/CD solution.
